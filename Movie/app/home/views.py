...
from Movie.app.home.forms import RegistForm, LoginForm, UserdetailForm, PwdForm,CommentForm
from Movie.app.models import User, Userlog, Comment, Movie,Preview,Tag,Moviecol
