...
from Movie.app.admin.forms import LoginForm, TagForm, MovieForm, PreviewForm, PwdForm, AuthForm, RoleForm, AdminForm
from Movie.app.models import Admin, Tag, Movie, Preview, User, Comment, Moviecol, Oplog, Adminlog, Userlog, Auth, Role
from functools import wraps  # 装饰器(用于访问控制)
from werkzeug.utils import secure_filename  # 将filename转化成安全的名称
from Movie.app import db, app
import os, stat
import uuid  # 生成唯一标志符
import datetime
